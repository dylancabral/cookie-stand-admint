...
export default function CreateForm() {
  return (
    <>
      <form className='w-3/4 p-2 mx-auto my-8 bg-blue-300 rounded'>
          ...
          <div className='flex flex-row justify-evenly'>
            ...
            <button className='bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2
'>Create</button>
          </div>
        </form>
    </>
